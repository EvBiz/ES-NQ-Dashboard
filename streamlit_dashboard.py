...
conditions = [
    (dfNewIndex['Close'].loc[:63].max() > dfNewIndex['Close'].loc[64:127].max()) & (dfNewIndex['Close'].loc[64:127].max() > dfNewIndex['Close'].loc[128:191].max()) & (dfNewIndex['Close'].loc[128:191].max() > dfNewIndex['Close'].loc[192:253].max()) & (dfNewIndex['Close'].loc[:63].min() > dfNewIndex['Close'].loc[64:127].min()) & (dfNewIndex['Close'].loc[64:127].min() > dfNewIndex['Close'].loc[128:191].min()) & (dfNewIndex['Close'].loc[128:191].min() > dfNewIndex['Close'].loc[192:253].min()),
    (dfNewIndex['Close'].loc[:63].max() < dfNewIndex['Close'].loc[64:127].max()) & (dfNewIndex['Close'].loc[64:127].max() < dfNewIndex['Close'].loc[128:191].max()) & (dfNewIndex['Close'].loc[128:191].max() < dfNewIndex['Close'].loc[192:253].max()) & (dfNewIndex['Close'].loc[:63].min() < dfNewIndex['Close'].loc[64:127].min()) & (dfNewIndex['Close'].loc[64:127].min() < dfNewIndex['Close'].loc[128:191].min()) & (dfNewIndex['Close'].loc[128:191].min() < dfNewIndex['Close'].loc[192:253].min())
    ]

conditionsnq = [
    (dfnqNewIndex['Close'].loc[:63].max() > dfnqNewIndex['Close'].loc[64:127].max()) & (dfnqNewIndex['Close'].loc[64:127].max() > dfnqNewIndex['Close'].loc[128:191].max()) & (dfnqNewIndex['Close'].loc[128:191].max() > dfnqNewIndex['Close'].loc[192:253].max()) & (dfnqNewIndex['Close'].loc[:63].min() > dfnqNewIndex['Close'].loc[64:127].min()) & (dfnqNewIndex['Close'].loc[64:127].min() > dfnqNewIndex['Close'].loc[128:191].min()) & (dfnqNewIndex['Close'].loc[128:191].min() > dfnqNewIndex['Close'].loc[192:253].min()),
    (dfnqNewIndex['Close'].loc[:63].max() < dfnqNewIndex['Close'].loc[64:127].max()) & (dfnqNewIndex['Close'].loc[64:127].max() < dfnqNewIndex['Close'].loc[128:191].max()) & (dfnqNewIndex['Close'].loc[128:191].max() < dfnqNewIndex['Close'].loc[192:253].max()) & (dfnqNewIndex['Close'].loc[:63].min() < dfNewIndex['Close'].loc[64:127].min()) & (dfnqNewIndex['Close'].loc[64:127].min() < dfnqNewIndex['Close'].loc[128:191].min()) & (dfnqNewIndex['Close'].loc[128:191].min() < dfnqNewIndex['Close'].loc[192:253].min())
    ]
